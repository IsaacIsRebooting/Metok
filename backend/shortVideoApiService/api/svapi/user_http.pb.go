...
func RegisterUserServiceHTTPServer(s *http.Server, srv UserServiceHTTPServer) {
	...
	r.POST("user/info", _UserService_GetUserInfo0_HTTP_Handler(srv))
	r.POST("user/update", _UserService_UpdateUserInfo0_HTTP_Handler(srv))
	r.POST("user/voucher", _UserService_BindUserVoucher0_HTTP_Handler(srv))
	r.POST("user/voucher", _UserService_UnbindUserVoucher0_HTTP_Handler(srv))
}
