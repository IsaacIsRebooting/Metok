...
const (
	FavoriteService_AddFavorite_FullMethodName       = "/svapi.FavoriteService/AddFavorite"
	FavoriteService_RemoveFavorite_FullMethodName    = "/svapi.FavoriteService/RemoveFavorite"
	FavoriteService_ListFavoriteVideo_FullMethodName = "/svapi.FavoriteService/ListFavoriteVideo"
)
...
type FavoriteServiceClient interface {
	...
	ListFavoriteVideo(ctx context.Context, in *ListFavoriteVideoRequest, opts ...grpc.CallOption) (*ListFavoriteVideoResponse, error)
}
...
func (c *favoriteServiceClient) ListFavoriteVideo(ctx context.Context, in *ListFavoriteVideoRequest, opts ...grpc.CallOption) (*ListFavoriteVideoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListFavoriteVideoResponse)
...
func (UnimplementedFavoriteServiceServer) ListFavoriteVideo(context.Context, *ListFavoriteVideoRequest) (*ListFavoriteVideoResponse, error) {
...
func _FavoriteService_ListFavoriteVideo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListFavoriteVideoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FavoriteServiceServer).ListFavoriteVideo(ctx, req.(*ListFavoriteVideoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FavoriteService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "svapi.FavoriteService",
