...
var file_svapi_file_proto_rawDesc = []byte{
	...
	0x09, 0x3a, 0x01, 0x2a, 0x22, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x83, 0x01, 0x0a, 0x18, 0x52,
	0x65, 0x70, 0x6f, 0x72, 0x74, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x46, 0x69, 0x6c, 0x65, 0x55,
...
func file_svapi_file_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_svapi_file_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_svapi_file_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_svapi_file_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_svapi_file_proto_msgTypes[3].Exporter = func(v any, i int) any {
