...
var file_svapi_favorite_proto_rawDesc = []byte{
	...
	0x22, 0x09, 0x2f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x12, 0x63, 0x0a, 0x0e, 0x52,
	...
	0x02, 0x0e, 0x3a, 0x01, 0x2a, 0x2a, 0x09, 0x2f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65,
	...
	0x3a, 0x01, 0x2a, 0x22, 0x14, 0x2f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x2f, 0x76,
	0x69, 0x64, 0x65, 0x6f, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74,
...
func file_svapi_favorite_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_svapi_favorite_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_svapi_favorite_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_svapi_favorite_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_svapi_favorite_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_svapi_favorite_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_svapi_favorite_proto_msgTypes[5].Exporter = func(v any, i int) any {
