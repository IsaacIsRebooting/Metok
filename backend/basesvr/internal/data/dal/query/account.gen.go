...
func newAccount(db *gorm.DB, opts ...gen.DOOption) account {
	...
	_account.TokNumber = field.NewString(tableName, "tok_number")
...
func (a *account) updateTableName(table string) *account {
	...
	a.TokNumber = field.NewString(table, "tok_number")
...
func (a *account) fillFieldMap() {
	...
	a.fieldMap["tok_number"] = a.TokNumber
}
